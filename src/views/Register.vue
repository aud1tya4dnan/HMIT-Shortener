<template>
  ...
  <!-- alert -->
  <div v-if="showalert" role="alert" class="rounded-xl border border-gray-100 bg-white p-4 dark:border-gray-800 dark:bg-gray-900 w-96">
    <div class="flex items-start gap-4">
      ...
      <div class="flex-1">
        <strong class="block font-medium text-gray-900 dark:text-white"> Successfuly Registered </strong>
    ...
    <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
      ...
      <main class="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
        <div class="max-w-xl lg:max-w-3xl">
          ...
          <form @submit.prevent="getFormValues" class="mt-8 grid grid-cols-6 gap-6">
...
export default {
  ...
  methods: {
    getFormValues(submitEvent) {
      this.firstname = submitEvent.target.elements.first_name.value;
      this.lastname = submitEvent.target.elements.last_name.value;
